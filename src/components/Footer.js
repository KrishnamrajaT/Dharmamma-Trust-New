  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        <Grid container spacing={{ xs: 4, md: 20 }} sx={{ mb: 4 }}>
          {/* Logo */}
          <Grid item xs={12} sm={6} md={4}>
            ...
            <Typography
              variant="body2"
              sx={{ lineHeight: 1.8, opacity: 0.9, mt: 2, width: "353px" }}
            >
              Dedicated to serving communities and spreading compassion through
              various social and religious initiatives.
            </Typography>
          </Grid>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
              ...
              <Box sx={{ display: "flex", gap: 1, alignItems: "flex-start" }}>
                ...
                <Typography variant="body2">
                  dharmammatrust@gmail.com
                </Typography>
              </Box>
              <Box sx={{ display: "flex", gap: 1, alignItems: "flex-start" }}>
                <LocationOnIcon sx={{ fontSize: "1.2rem", mt: 0.2 }} />
                <Typography variant="body2">
                  Gonupalli, Andhra Pradesh, India
                </Typography>
              </Box>
            </Box>
          </Grid>
